...
INTENT_CASES = (
    ...
    IntentCase("faculty", "Agriculture Sciences", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Business & Entrepreneurship", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Engineering", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Graduate Studies", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Health and Life Sciences", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Humanities & Social Sciences", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Science and Information Technology", QueryIntent.PROGRAM_CATALOG),
    IntentCase("faculty", "Which programs are in Graduate Studies?", QueryIntent.PROGRAM_CATALOG),
